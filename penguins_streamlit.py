# Imports libraries, sets up the titles for app, and loads the model
...
# Grabs all the user input that needed for prediction
...
#  creates multiple histograms to explain the predictions made by the model
